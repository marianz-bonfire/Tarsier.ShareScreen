...
using static Tarsier.ShareScreen.Core.Webcam.DirectShow.EditStreaming;

namespace Tarsier.ShareScreen.Core.Webcam.DirectX
{
    ...
    public class CaptureWebcam : EditStreaming.ISampleGrabberCB, IDisposable
    {
        ...
        public CaptureWebcam(Filter videoDevice) {
            ...
            _videoInfoHeader = new EditStreaming.VideoInfoHeader();
            CreateGraph();
        }
